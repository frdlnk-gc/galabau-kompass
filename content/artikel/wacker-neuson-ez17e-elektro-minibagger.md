---
title: 'Wacker Neuson EZ17e: Der Elektro-Minibagger, der einen Arbeitstag ohne Steckdose schafft'
...
steckbrief:
  Hersteller: Wacker Neuson SE, München
  Kategorie: Elektrischer Zero-Tail-Minibagger, 1,7-t-Klasse
  Antrieb: Lithium-Ionen-Batterie 23,4 kWh, Betrieb wahlweise im Akku- oder Netzbetrieb
  Leistungsdaten: Grabtiefe max. 2.490 mm, Grabradius max. 4.060 mm, Losbrechkraft max. 20,5 kN, Betriebsgewicht 1.797 bis 2.152 kg
  Laden: 100 bis 415 Volt, integrierte Batterieheizung, im Netzbetrieb gleichzeitig laden und arbeiten
  Preis: Auf Anfrage über Händler oder Miete; deutlich über dem Diesel-Pendant (Herstellerangabe zum Aufpreis liegt uns nicht vor)
  Für wen: Betriebe mit Aufträgen in Innenräumen, Innenstädten, Nachtbaustellen und emissionsbeschränkten Ausschreibungen
  Stand: Herstellerangaben, abgerufen September 2026
bild_alt: Elektrischer Minibagger ohne Hecküberstand arbeitet in einem engen Innenhof zwischen Hauswänden
bild_prompt: A compact zero-tail electric mini excavator working in a narrow urban courtyard between building walls in Germany, no exhaust, a worker with hearing protection nearby, realistic documentary photo, no logos, no text.
bild_caption: 'Kein Abgas, wenig Lärm: Im Innenhof spielt der Elektroantrieb seinen Vorteil aus.'
relevanz: 60
quellen:
- t: 'Wacker Neuson: Elektrischer Zero Tail Kettenbagger EZ17e (technische Daten, Ladekonzept)'
  u: https://www.wackerneuson.de/zero-emission/elektro-bagger/ez17e
- t: 'electrive.net: Wacker Neuson zeigt E-Minibagger EZ17e, 13. August 2020'
  u: https://www.electrive.net/2020/08/13/wacker-neuson-zeigt-e-minibagger-ez17e/
- t: 'HKL Baumaschinen: Wacker Neuson EZ17e (Betriebsgewicht, Abmessungen)'
  u: https://www.hkl-baumaschinen.de/neuson-ez17e
---
